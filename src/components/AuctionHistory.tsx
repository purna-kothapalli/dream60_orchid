        ...
        <CardContent className="p-2.5 sm:p-6 relative z-10">
          <div className="flex flex-col gap-2 sm:gap-4">
            ...
            <div className="flex items-start justify-between gap-2" onClick={() => onViewDetails(localAuction)}>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5 sm:gap-2 mb-1 sm:mb-2">
                  <div
                    className={`w-7 h-7 sm:w-10 sm:h-10 rounded-xl sm:rounded-xl flex items-center justify-center shadow-md sm:shadow-lg border border-white/60 sm:border-2 ${localAuction.status === 'won'
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-1 sm:gap-2 md:gap-3" onClick={() => onViewDetails(localAuction)}>
              ...
              <div className={`backdrop-blur-xl rounded-md sm:rounded-xl p-1.5 sm:p-3 border shadow-sm ${localAuction.status === 'won'
            ...
            <CardContent className="p-4 relative z-10">
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3">
                ...
                <motion.div
                  ...
                  className="relative overflow-hidden"
                >
                  <div className={`bg-gradient-to-br backdrop-blur-xl rounded-2xl p-2.5 border-2 shadow-lg h-full ${netGain >= 0
                    ...
                    <div className="flex items-center gap-1.5 mb-1">
                      <div className={`w-6 h-6 rounded-lg flex items-center justify-center shadow-md ${netGain >= 0 ? 'bg-gradient-to-br from-blue-500 to-cyan-600' : 'bg-gradient-to-br from-orange-500 to-red-600'
                        }`}>
                        <Sparkles className="w-3.5 h-3.5 text-white" />
                      </div>
                      <div className={`text-[10px] font-bold uppercase tracking-tight ${netGain >= 0 ? 'text-blue-700' : 'text-orange-700'
                        }`}>
          ...
          <div className="hidden sm:grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <motion.div
                ...
                transition={{ delay: 0.4, duration: 0.5 }}
              >
                <Card className={`relative overflow-hidden border-2 backdrop-blur-2xl shadow-xl ${netGain >= 0
                  ...
                  <div className={`absolute inset-0 ${netGain >= 0
                  ...
                  <CardContent className="p-6 relative z-10">
                    <motion.div
                      ...
                      className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-4 shadow-lg ${netGain >= 0
                    ...
                    <div className={`text-sm mb-2 font-medium ${netGain >= 0 ? 'text-violet-700' : 'text-purple-700'
                      }`}>
                      Net {netGain >= 0 ? 'Gain' : 'Loss'}
                    </div>
                    <div className={`flex items-center gap-1 text-3xl font-bold ${netGain >= 0 ? 'text-violet-900' : 'text-purple-900'
                      }`}>
                      {netGain >= 0 ? '+' : ''}
                      <IndianRupee className="w-6 h-6" />
                      <span>{Math.abs(netGain).toLocaleString('en-IN')}</span>
                    </div>
                    <div className={`text-xs mt-2 ${netGain >= 0 ? 'text-violet-600' : 'text-purple-600'
                      }`}>
